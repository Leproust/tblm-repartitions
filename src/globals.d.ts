...
declare function obtenirPoids(config: any): any;
declare function affecterJoueurs(joueurs: any[], creneaux: any[], config: any): any[];
...
declare function optimisationComplete(creneaux: any[]): void;
