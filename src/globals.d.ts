...
declare function calculerScoreV2Brut(joueur: any, creneau: any, config: any): number;
declare function categorieCompatible(joueur: any, creneau: any): boolean;
declare function competitionCompatible(joueur: any, creneau: any): boolean;
declare function ageCompatible(joueur: any, creneau: any): boolean;
declare function cleComparaisonTexte(valeur: any): string;
declare function exporterCandidatsParCreneau(joueurs: any[], creneaux: any[], config: any): any;
