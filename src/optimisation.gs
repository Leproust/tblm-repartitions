...
function tenterAmelioration(
  ...
  */
  ...
  const couples =
    genererCouplesCreneaux(
      creneaux
    );


  for(
    let couple of couples
  ){
 ...
 * ===========================================================
 */
function genererCouplesCreneaux(
  creneaux
){
...
function testerEchange(
  ...
  for(
    let i=0;
    i<groupeA.joueurs.length;
    i++
  ){

    for(
      let j=0;
      j<groupeB.joueurs.length;
      j++
    ){
 ...
 * ===========================================================
 */
function tenterDeplacement(
  creneaux
){

  for(
    let source of creneaux
  ){

    for(
      let joueur of source.joueurs
    ){

      for(
        let destination of creneaux
      ){
